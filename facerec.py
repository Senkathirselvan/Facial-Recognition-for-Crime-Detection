...
size = 2
haar_cascade = cv2.CascadeClassifier(r'/home/senkathir/ssenkathir/machine_learning/machine_learning2/Facial-Recognition-for-Crime-Detection/face_cascade.xml')
